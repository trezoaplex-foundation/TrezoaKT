...
import com.trezoa.api.getAccountInfo
import com.trezoa.api.getMultipleAccountsInfo
...
suspend fun Action.getMintData(
    ...
    val account = this.api.getAccountInfo(TrezoaAccountSerializer(Mint.serializer()), mintAddress).getOrElse {
