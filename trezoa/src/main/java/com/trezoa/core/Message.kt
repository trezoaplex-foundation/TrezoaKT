// This is a code is a port from https://github.com/portto/trezoa-web3.kotlin
package com.trezoa.core

import com.trezoa.vendor.borshj.BorshBuffer
...
class Message(
    ...
    val instructions: List<com.trezoa.core.CompiledInstruction>
) {
    ...
    companion object {
        ...
        fun from(buffer: ByteArray): Message {
            ...
            val instructions = mutableListOf<com.trezoa.core.CompiledInstruction>()
