...
import com.trezoa.vendor.bip32.crypto.Hash;
import com.trezoa.vendor.bip32.crypto.HdUtil;
import com.trezoa.vendor.bip32.crypto.HmacSha512;
import com.trezoa.vendor.bip32.crypto.Secp256k1;
...
public class HdKeyGenerator {
    ...
    public HdAddress getAddressFromSeed(byte[] seed, TrezoaCoin trezoaCoin) {

        TrezoaCurve curve = trezoaCoin.getCurve();
        HdPublicKey publicKey = new HdPublicKey();
        HdPrivateKey privateKey = new HdPrivateKey();
        HdAddress address = new HdAddress(privateKey, publicKey, trezoaCoin, MASTER_PATH);
