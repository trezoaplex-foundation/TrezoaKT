...
import com.trezoa.api.requestAirdrop
import com.trezoa.api.sendTransaction
import com.trezoa.api.simulateTransaction
...
class ActionsTests {
    ...
    fun TestCreateTokenAccount()= runTest {
        ...
        val result = trezoa.action.createTokenAccount(sender, PublicKey("6AUM4fSvCAxCugrbJPFxTqYFp9r3axYx973yoSyzDYVH")).getOrThrow()
        Assert.assertNotNull(result)
    }
    ...
    fun sendTransactionTests() = runTest {
        ...
        val result = trezoa.api.sendTransaction(transaction, listOf(feePayer)).getOrThrow()
        Assert.assertNotNull(result)
    }
    ...
    fun getMintDataTest() = runTest {
        val result = trezoa.action.getMintData(PublicKey("8wzZaGf89zqx7PRBoxk9T6QyWWQbhwhdU555ZxRnceG3")).getOrThrow()
        Assert.assertNotNull(result)
    }
    ...
    @Test
    fun sendTPLTokensUnfundedAccountTest() = runTest {
