...
import com.trezoa.networking.serialization.format.BorshDecoder
import com.trezoa.networking.serialization.format.BorshEncoder
...
class DecodingTests {
    ...
    @Test
    fun testDecodingTrezoaplexMeta() {
    ...
    @Test
    fun testMoreDecodingTrezoaplexMeta() {

        val serializer = BorshAsBase64JsonArraySerializer(
            TrezoaplexMeta.serializer()
        )

        val plexData = TrezoaplexData("NFT", "BORSH", "www.trezoa.com")
        val plexMeta = TrezoaplexMeta(
            key = 1,
        ...
        assertEquals("www.trezoa.com", out.data.uri)
    }
